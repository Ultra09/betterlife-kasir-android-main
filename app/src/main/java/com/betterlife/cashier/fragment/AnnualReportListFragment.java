...
public class AnnualReportListFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        PdfGenerator.generate("Annual Report", dtlist);
