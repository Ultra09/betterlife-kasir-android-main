...
import com.betterlife.cashier.LoginActivity;
...
public class DaysReportListFragment extends Fragment implements OnClickListener {
    ...
    public void onClick(View v) {
        PdfGenerator.generate("Daily Report", dtlist);
