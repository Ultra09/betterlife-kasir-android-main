...
public class SettingListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<SettingContent.DummyItem>(getActivity(),
				...
				android.R.id.text1, new SettingContent(getActivity()).ITEMS));
	}

//	@Override
//	public void onResume() {
//		Shared.didLanguageChange(getActivity());
//
//		super.onResume();
//	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(new SettingContent(getActivity()).ITEMS.get(position).id);
	}
