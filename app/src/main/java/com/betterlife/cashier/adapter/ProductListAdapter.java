...
import com.betterlife.cashier.fragment.ProductAddFragment;
...
public class ProductListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.body2 = (TextView) vi.findViewById(R.id.textView3);
        ...
        holder.body2.setText("Stok: " + product.getStock());
